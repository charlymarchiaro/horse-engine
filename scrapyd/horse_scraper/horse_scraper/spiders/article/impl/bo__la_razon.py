...
class Params(BaseArticleSpiderParams):
    ...
    def get_crawl_start_urls(self) -> List[str]:
        return [
            ...
            "https://www.la-razon.com/voces/",
            "https://www.la-razon.com/la-revista/",
            "https://www.la-razon.com/ciudades/",
            "https://www.la-razon.com/suplementos/marcas/",
    ...
    def get_url_filter(self) -> UrlFilter:
        return UrlFilter(
            allow_re=[f"la-razon.com\/.+({self.date_allow_str}).+\/$"], deny_re=[]
        )

    # Sitemap params

    def get_sitemap_urls(self) -> List[str]:
        return ["https://www.la-razon.com/sitemap_index.xml"]

    def get_sitemap_follow(self) -> List[str]:
        return ["article-sitemap"]
    ...
    def parser_1(self, response):
        ...
        text = extract_all_text(
            response,
            root_xpath='(//div[contains(@class, "article-body")])[1]',
            exclude_list=[
