...
class Params(BaseArticleSpiderParams):
    ...
    def _get_spider_base_name(self) -> str:
        return "ve__el_nacional"

    def get_allowed_domains(self) -> List[str]:
        return ["elnacional.com"]
    ...
    def get_crawl_start_urls(self) -> List[str]:
        return [
            ...
            "https://www.elnacional.com/life-style/",
        ]

    def get_url_filter(self) -> UrlFilter:
        return UrlFilter(
            allow_re=["elnacional.com\/.+\/.{10,}\/$"],
            deny_re=["elnacional.com\/.+\/.+\/.+\/", "\/\.\/",],
        )

    # Sitemap params

    def get_sitemap_urls(self) -> List[str]:
        return ["https://www.elnacional.com/sitemap_index.xml"]
    ...
    def parser_1(self, response):
        ...
        text = extract_all_text(
            ...
            exclude_list=[
                ...
                (AttributeType.ID, "conelnacional"),
            ],
        )
